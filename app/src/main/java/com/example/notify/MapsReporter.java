...
public class MapsReporter extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void submitArea(View view){
        ...
        double x=(ua.lat-17)*1000000-210000;
        double y=(ua.lon-78)*1000000-150000;
        ...
        Toast.makeText(MapsReporter.this, att+" ", Toast.LENGTH_SHORT).show();
        System.out.println("ATT"+att);
        mDatabase.child("number").setValue(att+1);
        mDatabase.child("UnsafeAreas").child(ua.name).setValue(ua);
        //Toast.makeText(MapsReporter.this, "submitted", Toast.LENGTH_SHORT).show();
    }
    public void change(){
