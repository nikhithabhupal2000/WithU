...
// See the UserRecord reference doc for the contents of userRecord.
        ...
        volno=(EditText)findViewById(R.id.volunteerNO);
    ...
    public void onClick4(View view){
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabase.child("Volunteer").child(uid).setValue(volno);
        Toast.makeText(MainActivity.this,"Volunteer registration successful",Toast.LENGTH_LONG).show();
    }
...
*/
    ...
    public void takeVedio(){
        ...
        if(vedioIntent.resolveActivity(getPackageManager())!=null){
            startActivityForResult(vedioIntent,101);
        }
    }
